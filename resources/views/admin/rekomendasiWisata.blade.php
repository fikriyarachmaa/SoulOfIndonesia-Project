    ...
    <div class="flex-1 flex">
        ...
        <div class="grid grid-cols-1 justify-start items-start w-9/12"> 
            ...
            <div class="grid grid-cols-2 items-center bg-white dark:text-white dark:bg-gray-800">
                ...
                <button class="flex items-center w-auto px-5 py-2 text-sm tracking-wide text-white bg-yellow border-gray-300 rounded-lg hover:bg-green-dark hover:text-cream">
