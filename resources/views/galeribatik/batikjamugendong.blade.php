    ...
    <section id="jamugendong" class="pt-16 lg:pt-36 bg-cream">
        <div class="container mx-auto px-8">
            ...
            <div class="items-center">
                ...
                <p class="text-green-darkest font-regular text-justify pb-8 md:pb-10 font-bold">Motif Batik Jamu Gendong atau Batik Mbok Jamu memiliki filosofi yang dalam yang mencerminkan berbagai nilai dan aspek budaya Indonesia, antara lain:</p>
                <p class="text-green-darkest font-regular text-justify pb-8 md:pb-10">1. Kesehatan dan Kesejahteraan: Motif ini menggambarkan seorang wanita penjual jamu yang membawa ramuan tradisional untuk kesehatan dan kesejahteraan masyarakat. Ini mencerminkan perhatian terhadap kesehatan dan kebahagiaan anggota masyarakat.</p>
