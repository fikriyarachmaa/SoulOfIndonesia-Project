...
<section class="text-gray-600 body-font overflow-hidden pt-10">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0 shadow-2xl p-4">
        ...
        <div class="flex border-t border-green-dark py-2">
      ...
      <img alt="ecommerce" class="shadow-2xl lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="{{ asset($produks->foto) }}">
    </div>
